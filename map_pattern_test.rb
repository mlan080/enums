...
#create an empty array squares, iterate through the other array which is passed through an argument, squaring each element before pushing it using << into new array squares
  def test_squares
    numbers = [1, 2, 3, 4, 5]
    squares = []
    numbers.each do |number|
